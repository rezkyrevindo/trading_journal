...
import 'package:trading_journal/data/api/setting/setting_api.dart';
...
class SettingApiImpl implements SettingApi {
  final Dio dio = SettingServices.getSettingDio(
    "",
  );

  @override
  Future<Either<ExceptionMessage, Response?>> listSetting() async {
    return baseService(
      RequestEnum.POST,
      dio,
      UrlEnum.settingWebsite.name,
      tokenAuth: null,
    );
  }
}
